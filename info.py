...
DATABASE_NAME = environ.get('DATABASE_NAME', "Rebel")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/RJMoviessWorld') # How to open tutorial link for verification
